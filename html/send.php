<?php
	...
	$mail->Port       	= 587;
	$mail->Username   	= 'josue.bills@gmail.com';
	$mail->Password   	= 'scarFAC3';
	$mail->Subject    	= 'New '.$formTypes[$_POST['type']]. ' Message from JosueRivera.com';
	$mail->CharSet		= 'utf-8';
	$mail->WordWrap 	= 50;
	
	$mail->SetFrom('no-reply@josuerivera.com', 'JosueRivera.com');

	$mail->AddAddress('josue.bills@gmail.com');
